...
public class CriarEventActivity extends AppCompatActivity {
    ...
    public void cadastrarEventoOnline(int plataforma, String link, Button btnCriar) {
        ...
        LiveData<String> resultLD = criarEventViewModel.criarEventoOnline(newetNomeEvento, newetObjetivoC, newetDataPrevistaC, newetHorarioC, currentPhotoPath, link, plataforma, String.valueOf(privacidade));
