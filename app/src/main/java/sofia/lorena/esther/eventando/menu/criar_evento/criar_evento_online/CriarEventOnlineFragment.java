...
public class CriarEventOnlineFragment extends Fragment {
    ...
    public CriarEventOnlineFragment() {
    ...
    public static CriarEventOnlineFragment newInstance(String param1, String param2) {
        CriarEventOnlineFragment fragment = new CriarEventOnlineFragment();
